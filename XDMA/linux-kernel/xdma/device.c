                                  ...
                                  struct vcam_device *dev)
{
    ...
    int data = *(int*)sg_virt(sg);

    pr_info("vbuf_sgt at  0x%p last sg nent start value %u and end value %u\n", sg_virt(sg), *(int*)sg_virt(sg), *(int*)(sg_virt(sg)+sg_dma_len(sg)-sizeof(int)));
